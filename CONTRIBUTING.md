# Contributing to iOSUISpy
Welcome to [report Issues](https://github.com/qtacore/iOSUISpy/issues) or [pull requests](https://github.com/qtacore/iOSUISpy/pulls). It's recommended to read the following Contributing Guild first to make contributing earlier. 
...
## Pull Requests
We strongly welcome your pull request to make iOSUISpy better. 
...
## License
By contributing to iOSUISpy, you agree that your contributions will be licensed
under its [BSD LICENSE](https://github.com/qtacore/iOSUISpy/blob/master/LICENSE.TXT)